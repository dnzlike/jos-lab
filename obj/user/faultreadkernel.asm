	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800195:	0f be 80 91 11 80 00 	movsbl 0x801191(%eax),%eax
  80019c:	50                   	push   %eax
...
00800219 <vprintfmt>:
{
  ...
  800273:	ff 24 85 e0 12 80 00 	jmp    *0x8012e0(,%eax,4)
  ...
  80034a:	8b 14 85 40 14 80 00 	mov    0x801440(,%eax,4),%edx
  800351:	85 d2                	test   %edx,%edx
  800353:	74 18                	je     80036d <vprintfmt+0x154>
				printfmt(putch, putdat, "%s", p);
  800355:	52                   	push   %edx
  800356:	68 b2 11 80 00       	push   $0x8011b2
  80035b:	56                   	push   %esi
  80035c:	53                   	push   %ebx
  ...
  80036d:	50                   	push   %eax
  80036e:	68 a9 11 80 00       	push   $0x8011a9
  800373:	56                   	push   %esi
  800374:	53                   	push   %ebx
  ...
  800395:	b8 a2 11 80 00       	mov    $0x8011a2,%eax
  ...
  8007b8:	eb b2                	jmp    80076c <vprintfmt+0x553>
			if (!res) printfmt(putch, putdat, "%s", null_error);
  8007ba:	68 48 12 80 00       	push   $0x801248
  8007bf:	68 b2 11 80 00       	push   $0x8011b2
  8007c4:	56                   	push   %esi
  8007c5:	53                   	push   %ebx
  ...
  8007d6:	68 80 12 80 00       	push   $0x801280
  8007db:	68 b2 11 80 00       	push   $0x8011b2
  8007e0:	56                   	push   %esi
  8007e1:	53                   	push   %ebx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c74:	68 64 14 80 00       	push   $0x801464
  800c79:	6a 23                	push   $0x23
  800c7b:	68 81 14 80 00       	push   $0x801481
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cf5:	68 64 14 80 00       	push   $0x801464
  800cfa:	6a 23                	push   $0x23
  800cfc:	68 81 14 80 00       	push   $0x801481
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d37:	68 64 14 80 00       	push   $0x801464
  800d3c:	6a 23                	push   $0x23
  800d3e:	68 81 14 80 00       	push   $0x801481
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d79:	68 64 14 80 00       	push   $0x801464
  800d7e:	6a 23                	push   $0x23
  800d80:	68 81 14 80 00       	push   $0x801481
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dbb:	68 64 14 80 00       	push   $0x801464
  800dc0:	6a 23                	push   $0x23
  800dc2:	68 81 14 80 00       	push   $0x801481
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dfd:	68 64 14 80 00       	push   $0x801464
  800e02:	6a 23                	push   $0x23
  800e04:	68 81 14 80 00       	push   $0x801481
...
sys_ipc_recv(void *dstva)
{
  ...
  800e61:	68 64 14 80 00       	push   $0x801464
  800e66:	6a 23                	push   $0x23
  800e68:	68 81 14 80 00       	push   $0x801481
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ecf:	56                   	push   %esi
  800ed0:	50                   	push   %eax
  800ed1:	68 90 14 80 00       	push   $0x801490
  ...
  800ee2:	e8 03 f2 ff ff       	call   8000ea <vcprintf>
	cprintf("\n");
  800ee7:	c7 04 24 b4 14 80 00 	movl   $0x8014b4,(%esp)
