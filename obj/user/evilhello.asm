...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 6a 11 80 00       	push   $0x80116a
  800114:	6a 23                	push   $0x23
  800116:	68 87 11 80 00       	push   $0x801187
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 6a 11 80 00       	push   $0x80116a
  800195:	6a 23                	push   $0x23
  800197:	68 87 11 80 00       	push   $0x801187
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 6a 11 80 00       	push   $0x80116a
  8001d7:	6a 23                	push   $0x23
  8001d9:	68 87 11 80 00       	push   $0x801187
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 6a 11 80 00       	push   $0x80116a
  800219:	6a 23                	push   $0x23
  80021b:	68 87 11 80 00       	push   $0x801187
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 6a 11 80 00       	push   $0x80116a
  80025b:	6a 23                	push   $0x23
  80025d:	68 87 11 80 00       	push   $0x801187
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800298:	68 6a 11 80 00       	push   $0x80116a
  80029d:	6a 23                	push   $0x23
  80029f:	68 87 11 80 00       	push   $0x801187
...
sys_ipc_recv(void *dstva)
{
  ...
  8002fc:	68 6a 11 80 00       	push   $0x80116a
  800301:	6a 23                	push   $0x23
  800303:	68 87 11 80 00       	push   $0x801187
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80036a:	56                   	push   %esi
  80036b:	50                   	push   %eax
  80036c:	68 98 11 80 00       	push   $0x801198
  ...
  80037d:	e8 56 00 00 00       	call   8003d8 <vcprintf>
	cprintf("\n");
  800382:	c7 04 24 bb 11 80 00 	movl   $0x8011bb,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800483:	0f be 80 bd 11 80 00 	movsbl 0x8011bd(%eax),%eax
  80048a:	50                   	push   %eax
...
00800507 <vprintfmt>:
{
  ...
  800643:	52                   	push   %edx
  800644:	68 de 11 80 00       	push   $0x8011de
  800649:	56                   	push   %esi
  80064a:	53                   	push   %ebx
  ...
  80065b:	50                   	push   %eax
  80065c:	68 d5 11 80 00       	push   $0x8011d5
  800661:	56                   	push   %esi
  800662:	53                   	push   %ebx
  ...
  800683:	b8 ce 11 80 00       	mov    $0x8011ce,%eax
  ...
  800aa6:	eb b2                	jmp    800a5a <vprintfmt+0x553>
			if (!res) printfmt(putch, putdat, "%s", null_error);
  800aa8:	68 74 12 80 00       	push   $0x801274
  800aad:	68 de 11 80 00       	push   $0x8011de
  800ab2:	56                   	push   %esi
  800ab3:	53                   	push   %ebx
  ...
  800ac4:	68 ac 12 80 00       	push   $0x8012ac
  800ac9:	68 de 11 80 00       	push   $0x8011de
  800ace:	56                   	push   %esi
  800acf:	53                   	push   %ebx
